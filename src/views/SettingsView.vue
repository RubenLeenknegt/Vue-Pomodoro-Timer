        ...
        <div class="bg-white p-8 rounded-2xl shadow-md max-w-2xl w-full text-center">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form @submit.prevent="form_submit">
                    <div>
                        <label class="grid justify-start text-sm/6 font-bold text-gray-900" for="pomodoro-duration">Work time in minutes</label>
                        <div>
                            <input class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" v-model="workTime" type="number" id="pomodoro-duration" min="1" max="60">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            <input class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" v-model="breakTime" type="number" id="break-duration" min="1" max="60"> 
                        </div>
                    </div>
